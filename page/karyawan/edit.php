      ...
      <form role="form" method="post">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control input-lg" id="exampleInputEmail1" placeholder="Masukan NIP / NIDN" name="NIP" value="<?php echo $data['NIP']; ?>" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control custom-select input-lg" name="JK">
              ...
              <option value="Pria" <?php if ($data['JK'] == "Pria") {
                                      echo "selected";
                                    } else {
                                      echo "";
                                    } ?>>Pria</option>
              <option value="Wanita" <?php if ($data['JK'] == "Wanita") {
                                        echo "selected";
                                      } else {
                                        echo "";
                                      } ?>>Wanita</option>
