...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>Aplikasi</b>Penilaian Kerja</span>
      </a>
        ...
        <ul class="sidebar-menu">
          ...
          <?php if (@$_SESSION['logged'] == 1) : ?>
            ...
            <li class="<?= (@$_GET['p'] == 'bobot') ? 'active' : '' ?>">
              <a href="#">
                <i class="fa fa-list"></i> <span>Nilai Kriteria</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://github.com/tegarsatya">Pottsed</a>.</strong> All rights
    reserved.
  </footer>
